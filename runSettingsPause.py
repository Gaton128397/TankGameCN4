...
def run_settings():
    ...
    home_button = button.Button((x*0.5 - 10, x*0.5 - params.size*0.2, params.size, params.size), (255, 0, 0), 'Home', False)
    confirmar_button = button.Button((width - x*1.5 - params.size*2.5, x*0.5 + 650, 300, 100), (255, 0, 0), 'Settings', False)
