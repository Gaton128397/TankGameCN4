...
def buttons():
    buttons = [ 
        ...
        Button(0.06, 0.22, 0.11, 0.15,createItems()[0]), #escudo
        Button(0.22, 0.22, 0.11, 0.15,createItems()[1]), #espada
        Button(0.36, 0.22, 0.11, 0.15,createItems()[2]), #corazon
        Button(0.50, 0.22, 0.11, 0.15,createItems()[3]), #piedra grande
        Button(0.66, 0.22, 0.11, 0.15,createItems()[4]), #piedra pequena
        Button(0.80, 0.22, 0.11, 0.15,createItems()[5]) #piedra mediana
        ]
