...
class TerrenoVariado:
    ...
    def drawTerrain(self):
        self.window.fill((173, 216, 230))  # lightblue color
        ...
        pygame.draw.polygon(self.window, (255, 213, 158), [(0, self.height)] + points_interp + [(self.width, self.height)])
        pygame.draw.lines(self.window, (139, 69, 19), False, points_interp, 5)
