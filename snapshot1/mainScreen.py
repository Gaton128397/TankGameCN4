...
import pygame,projectile,tank,terreno,time,cloud,bird
    ...
    while True:
        ...
        try:
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_SPACE:
                        ...
                        if turno == 1:
                            ...
                            bullet1 = projectile.Projectile(positionBullet1,potencia,angleBullet1,8,window)
            
                            deleteBullet = projectile.Projectile(positionBullet1,potencia,angleBullet1,8,window)
                            ...
                            bullet2 = projectile.Projectile(positionBullet2,potencia,angleBullet2,3,window) 
            
                            deleteBullet2 = projectile.Projectile(positionBullet2,potencia,angleBullet2,3,window)
            ...
            if turno ==1:
                ...
                textoRange1 = fuente.render(f'LAST RANGE PLAYER {turno}: {range1:.1f} meters', True, 'black')
                ...
                textoAltura2 = fuente.render(f'LAST HEIGHT PLAYER {turno}: {alturamaxima2:.1f} meters', True, 'black')
                
                pygame.draw.rect(window, (255, 213, 158), (50,660,370, 50))
            ...
            if turno ==2:
                ...
                textoRange2 = fuente.render(f'LAST RANGE PLAYER {turno}: {-1*range2:.1f} meters', True, 'black')
                ...
                pygame.draw.rect(window, (255, 213, 158), (900,660,370, 50))
